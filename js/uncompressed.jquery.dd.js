...
;(function($) { 
   ...
   var dd = function(element, options)
   {
	...
	var createDropDown = function () {
		...
		$("#"+titletextid).css("width", (iWidth-40)+"px"); // value changed by Tara to adjust the selected item's width.
		$("#"+titletextid).css("display", "inline-block");
	...
	this.reset = function() {
		if($this.get("multiple") == true) {
			var childid = getPostID("postChildID");
			$("#"+childid+" a").removeClass("selected");
		} else {
			$this.set("selectedIndex", 0);
		}
	};
